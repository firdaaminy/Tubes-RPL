 ...
 * @author Iwan Ma'ruf
 */
public class DekanHome extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DekanHome.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
